...
public class ChessBoard {
    ...
    public Collection<ChessPosition> getTeamPiecePositions(ChessGame.TeamColor team) {
        Collection<ChessPosition> teamPiecePositions = new ArrayList<ChessPosition>();
    ...
    public boolean checkEmptyColumnsBetweenPiecesInRow(ChessPosition positionLeft, ChessPosition positionRight) {
        ...
        for (int i = startColumn + 1; i < endColumn; i++) {
            ChessPosition currentPosition = new ChessPosition(row, i);
    ...
    private void ifCastleMoveDoPartnerMove(ChessMove move) {
        ...
        * */
        if (move.getIsCastleMove() ||
            (pieceType == ChessPiece.PieceType.KING && columnDifferential > 1)
        ) {
